...
const getContracts = (signer?: Signer) => ({
    ...
    TestArbitrageFormula: deployOrAttach('TestArbitrageFormula', TestArbitrageFormula__factory, signer),
    TestDefaultFormula: deployOrAttach('TestDefaultFormula', TestDefaultFormula__factory, signer),
    TestThresholdFormula: deployOrAttach('TestThresholdFormula', TestThresholdFormula__factory, signer),
